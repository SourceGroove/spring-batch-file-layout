...
public class StreamingExcelSheetTokenizer {

    private FieldSetFactory fieldSetFactory = new DefaultFieldSetFactory();
    private DataFormatter formatter = new StreamingExcelDataFormatter();
    ...
    private Iterator<FieldSet> tokenize(Map<Integer, List<Object>> rows) {
        if (rows == null || CollectionUtils.isEmpty(rows.keySet())) {
